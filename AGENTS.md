...
This project is indexed by GitNexus as **nexus-platform** (10290 symbols, 20569 relationships, 253 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
