...
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **P0 (Khẩn cấp/Bảo mật/Pháp lý)** | 4 | 1 | 0 | 0 | **3** | 0 |
| **P1 (Tính năng bắt buộc học kỳ)** | 10 | 4 | 0 | 0 | **5** | **1 (Bỏ)** |
| **P2 (Cải tiến & Nợ kỹ thuật)** | 8 | 7 | 0 | 0 | **1** | 0 |
| **TỔNG CỘNG** | **22** | **12** | **0** | **0** | **9** | **1** |
...
| **GA-04** | Xóa tài khoản (NĐ 13/2023 72h) | P0 | ❌ **Todo** | [`bugs/ga-04-account-deletion-compliance.md`](./bugs/ga-04-account-deletion-compliance.md) |
| **GA-05** | Upload Avatar người dùng | P1 | ✅ **Done** | [`bugs/ga-05-avatar-upload.md`](./bugs/ga-05-avatar-upload.md) |
| **GA-06** | UI quản lý Session/Thiết bị | P1 | ❌ **Todo** | [`bugs/ga-06-session-management-ui.md`](./bugs/ga-06-session-management-ui.md) |
...
| **GA-14** | Rút tiền thủ công khỏi ví | P2 | ⚠️ **Partially** | [`bugs/ga-14-wallet-manual-withdrawal.md`](./bugs/ga-14-wallet-manual-withdrawal.md) |
