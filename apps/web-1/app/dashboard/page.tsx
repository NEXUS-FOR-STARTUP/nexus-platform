        ...
        {!isLoading && (total > 0 || hasActiveFilters) && (
          <div className="flex items-center gap-2 sm:gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 font-body text-xs sm:text-sm font-semibold bg-brand hover:bg-brand-hover text-white px-3 sm:px-4 py-2 h-9 sm:h-10 rounded-lg shadow-sm shadow-brand/10 transition-colors cursor-pointer whitespace-nowrap"
            >
              <span>Đánh giá đội ngũ</span>
            </Link>
            <button
              onClick={open}
              className="inline-flex items-center justify-center gap-2 font-body text-xs sm:text-sm font-semibold bg-surface-app border border-border-app hover:border-brand/40 text-text-app px-3 sm:px-4 py-2 h-9 sm:h-10 rounded-lg transition-colors cursor-pointer whitespace-nowrap"
            >
